...
public class ExtentReportManager implements ITestListener
{
	...
	{		
		...
		htmlReporter.config().setDocumentTitle("OrangeHRM Automation Report"); // Tile of report
		htmlReporter.config().setReportName("OrangeHRM Regression Testing"); // name of the report
